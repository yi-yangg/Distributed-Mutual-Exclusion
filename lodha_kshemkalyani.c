...
void listenIncomingRequest(bool isRequesting) {
    ...
    if (request_flag) {
        int Pj_SN = received_request.sequence_number;
        int Pj_rank = received_request.process_id;
